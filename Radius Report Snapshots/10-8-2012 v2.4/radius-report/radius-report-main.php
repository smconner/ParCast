...
define("radius_report_version", "2.4");
...
/** 
 * 	This function enques all of the wordpress built-in scripts needed to allow certain 'widget like' funcitonality in this plugin
 */
...
removes page header icon

.wp-admin .icon32 {
	display:none;
}

makes page header name smaller
