...
/** ----------- PROCESS CHECK ----------- **/
	...
	$invoice_description = $_POST['x_plan'] . " credit(s) - ASTM E1527-05 radius map report";
	...
	$transaction_fields = array(
		...
		'echeck_type' => $_POST['x_echeck_type'],
		'recurring_billing' => $_POST['x_recurring_billing'],
		'bank_aba_code' => $_POST['x_bank_aba_code'],
		'bank_acct_num' => $_POST['x_bank_acct_num'],
		'bank_acct_type' => $_POST['x_bank_acct_type'],
		'bank_name' => $_POST['x_bank_name'],
		'bank_acct_name' => $_POST['x_bank_acct_name'] );
