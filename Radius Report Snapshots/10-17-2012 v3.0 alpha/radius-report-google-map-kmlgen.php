...
require_once dirname(__FILE__) . '/radius-report-config.php';
	...
	$lng_site = $aUserSite[ 'site_lng' ];															// get the site longitude
	$lat_site = $aUserSite[ 'site_lat' ];															// get the site latitude
	...
	/**
	 *	Generates an on-demand KML file for google (or anyone on the internet)
	 */
