...
class MySQL {
	...
	var $sHostname = GEO_MYSQL_HOST;	// MySQL Hostname
	var $sUsername = GEO_MYSQL_USER;	// MySQL Username
	var $sPassword = GEO_MYSQL_PASS;	// MySQL Password
	var $sDatabase = GEO_MYSQL_DB_NAME;	// MySQL Database
