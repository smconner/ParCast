...
require_once dirname(__FILE__) . "/../../../../radius-report-generator-supplements.php";
...
function report_minder( $execute_time, $local_user_path, $base_filename, $lng_site, $lat_site, $user_max_search_radius, $this_current_user_login ) {
	 ...
	 */
		...
		error_log("      CHILD MINDER: PNG GENERATOR OFFLINE");
	 ...
	 */
		...
		error_log("      CHILD MINDER: PDF IMAGES GENERATOR OFFLINE");
	
	
	/**
	 *	Run Orphans and Suspects
	 */
		//make_supplements($local_user_path, $base_filename, $lng_site, $lat_site, $user_max_search_radius);
