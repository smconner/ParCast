...
class MySQL {
	...
	var $sHostname = EPA_API_MYSQL_HOST;	// MySQL Hostname
	var $sUsername = EPA_API_MYSQL_USER;	// MySQL Username
	var $sPassword = EPA_API_MYSQL_PASS;	// MySQL Password
	var $sDatabase = EPA_API_MYSQL_DB_NAME;	// MySQL Database
