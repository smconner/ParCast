...
function radius_report_printmap() {
	...
	//error_log( "STATE: ". print_r($json_object->results[0]->address_components[4]->short_name,1));
	//error_log( "COUNTY: ". print_r($json_object->results[0]->address_components[3]->short_name,1));
	//error_log( "CITY: ". print_r($json_object->results[0]->address_components[2]->short_name,1));
	...
	<script type='text/javascript' src='" . RR_HTTP_HOST . "/wp-content/plugins/radius-report/js/geoxml3.js'></script>
	<script type='text/javascript' src='" . RR_HTTP_HOST . "/wp-content/plugins/radius-report/js/ProjectedOverlay.js'></script>
